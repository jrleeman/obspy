# -*- coding: utf-8 -*-
"""
obspy.dyna - DYNA and ITACA read and write support
==================================================

This module provides read and write support for waveform data in the DYNA
format as defined by INGV Milano - Pavia.

:copyright:
    The ObsPy Development Team (devs@obspy.org), Emiliano Russo &
    Rodolfo Puglia.
:license:
...
of the :mod:`obspy.core` module. Examples seismograms files may be found at
http://examples.obspy.org.

>>> from obspy import read
>>> st = read("/path/to/QFILE-TEST-ASC.DAT")
>>> st #doctest: +ELLIPSIS
...
>>> st.write('file.dat', format='DYNA') #doctest: +SKIP
